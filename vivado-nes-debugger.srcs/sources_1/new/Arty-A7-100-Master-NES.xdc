...
#set_disable_timing debuggerTopi_2_4/nes/i_2_10/i_2_1394 -from I0 -to O
...
## Pmod Header JD
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { o_nes_latch }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { o_nes_clk }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
#set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { i_nes_d0_player_2 }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { i_nes_d0_player1 }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
...
# JK - hack for i_spi_clk not being on a clock pin
...
## allow combinatorial loops for CPU6502/NES design
# see: https://support.xilinx.com/s/question/0D52E00006hpdq2/how-to-apply-setproperty-allowcombinatorialloops-true-to-pass-combinatorial-loops?language=en_US
